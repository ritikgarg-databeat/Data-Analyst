...
def create_tag(
    payload: CreateTagRequest, admin: AdminUser, service: Annotated[TagService, Depends(get_tag_service)]
) -> Tag:
...
def delete_tag(
    tag_id: str, admin: AdminUser, service: Annotated[TagService, Depends(get_tag_service)]
) -> None:
